...
- 기존 `reports/Report_*.html`이 있으면 사이트 shell 안에 삽입하고, 없으면 CSV/Markdown을 사용해 페이지를 재렌더링합니다. 과거 루트 `Report_*.html`은 읽기 fallback으로만 지원합니다.
...
- 상세페이지 v2 렌더 확인: `reports/Report_Kospi_20260427.html`, `site/kospi/index.html`, `site/dow30/index.html`에 Sector Heatmap, Setup Buckets, MA Distance Scatter, Fear & Volatility 패널 반영됨.
